...
public enum ModArmourMaterials implements ArmorMaterial {
    ...
    HELLSTONE("hellstone", 25, new int[]{2, 5, 7, 2}, 9, SoundEvents.ARMOR_EQUIP_NETHERITE, 1.0F, 0.0F, () -> {
        Clojure.var("clojure.core", "require").invoke(Clojure.read("com.teamclojure.ModItems"));
        Object item = Clojure.var("com.teamclojure.ModItems", "hellstone-ingot").invoke();
        return Ingredient.of((net.minecraft.world.item.Item) item);
    });
