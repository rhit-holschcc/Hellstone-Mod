...
(defn start [eventBus]
	(def ^DeferredRegister ITEMS (DeferredRegister/create ForgeRegistries/ITEMS "examplemod"))
	(def ^DeferredRegister BLOCKS (DeferredRegister/create ForgeRegistries/BLOCKS "examplemod"))
